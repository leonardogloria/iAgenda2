	...
	<body>
		...
		<div id="show-telefone" class="content scaffold-show" role="main">
			...
			<ol class="property-list telefone">
				...
				<g:if test="${telefoneInstance?.isCelular}">
				<li class="fieldcontain">
					<span id="isCelular-label" class="property-label"><g:message code="telefone.isCelular.label" default="Is Celular" /></span>
					
						<span class="property-value" aria-labelledby="isCelular-label"><g:formatBoolean boolean="${telefoneInstance?.isCelular}" /></span>

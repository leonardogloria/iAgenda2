		...
		<div id="list-telefone" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="isCelular" title="${message(code: 'telefone.isCelular.label', default: 'Is Celular')}" />
				...
				<g:each in="${telefoneInstanceList}" status="i" var="telefoneInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${telefoneInstance.isCelular}" /></td>

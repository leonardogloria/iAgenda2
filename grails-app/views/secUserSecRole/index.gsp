		...
		<div id="list-secUserSecRole" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="secUserSecRole.sercRole.label" default="Serc Role" /></th>
				...
				<g:each in="${secUserSecRoleInstanceList}" status="i" var="secUserSecRoleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${secUserSecRoleInstance.id}">${fieldValue(bean: secUserSecRoleInstance, field: "sercRole")}</g:link></td>
